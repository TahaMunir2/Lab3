...
VL_ATTR_COLD void Vf1_fsm___024root__trace_init_sub__TOP__0(Vf1_fsm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+4,0,"data_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+5,0,"current_state",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INT, false,-1, 31,0);
...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_0_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+5,(vlSelfRef.f1_fsm__DOT__current_state),32);
    bufp->fullIData(oldp+6,(((IData)(vlSelfRef.__VdfgRegularize_h0dff6736_0_7)
                              ? ((0U == vlSelfRef.f1_fsm__DOT__current_state)
                                  ? 1U : ((1U == vlSelfRef.f1_fsm__DOT__current_state)
                                           ? 2U : (
                                                   (2U 
                                                    == vlSelfRef.f1_fsm__DOT__current_state)
                                                    ? 3U
                                                    : 
                                                   ((3U 
                                                     == vlSelfRef.f1_fsm__DOT__current_state)
